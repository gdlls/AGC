...
/** Called before an AGC arena enters RUNNING phase. */
public final class AGCMatchStartEvent extends AGCArenaEvent implements Cancellable {
    private static final HandlerList HANDLER_LIST = new HandlerList();
    private boolean cancelled;

    public AGCMatchStartEvent(final @NotNull AGCArena arena) {
        super(arena);
    }
