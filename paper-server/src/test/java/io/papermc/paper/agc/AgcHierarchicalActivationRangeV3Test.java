...
public class AgcHierarchicalActivationRangeV3Test {
    ...
    void testTierEvaluationAndFrequencyGating() {
        // Distance 10m -> Tier 0 (Full Combat / Proximity)
        final AgcHierarchicalActivationRangeV3.EarTier tier0 =
            AgcHierarchicalActivationRangeV3.get().evaluateTier(100.0, false, false);
        ...
        // Distance 25m -> Tier 1 (Standard Tick)
        ...
        // Distance 50m -> Tier 2 (Reduced Cadence 10Hz)
        final AgcHierarchicalActivationRangeV3.EarTier tier2 =
            AgcHierarchicalActivationRangeV3.get().evaluateTier(2500.0, false, false);
        ...
        // Distance 100m -> Tier 3 (Minimal Cadence 5Hz)
        final AgcHierarchicalActivationRangeV3.EarTier tier3 =
            AgcHierarchicalActivationRangeV3.get().evaluateTier(10000.0, false, false);
        ...
        // Distance 150m -> Tier 4 (Frozen / Inactive 1Hz)
